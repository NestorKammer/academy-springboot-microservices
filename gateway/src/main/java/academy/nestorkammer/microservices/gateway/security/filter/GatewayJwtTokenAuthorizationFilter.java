package academy.nestorkammer.microservices.gateway.security.filter;
...
import static academy.nestorkammer.microservices.token.security.util.SecurityContextUtil.setSecurityContext;
