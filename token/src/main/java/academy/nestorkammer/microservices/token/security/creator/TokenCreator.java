package academy.nestorkammer.microservices.token.security.creator;
...
public class TokenCreator {
    ...
    private JWTClaimsSet createJWTClaimSet(Authentication auth, ApplicationUser applicationUser) {
        ...
        return new JWTClaimsSet.Builder()
                ...
                .issueTime(new Date())
                .expirationTime(new Date(System.currentTimeMillis() + (jwtConfiguration.getExpirationTime() * 1000)))
                .build();
    }
    ...
    public String encryptToken(SignedJWT signedJWT) throws JOSEException {
        ...
        log.info("Encryption token with system´s private key");
